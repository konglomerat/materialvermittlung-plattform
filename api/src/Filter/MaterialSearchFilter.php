...
final class MaterialSearchFilter extends AbstractContextAwareFilter {
    ...
    protected function filterProperty(string $property, $value, QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, string $operationName = null)
    {
        ...
        if(is_string($value) && $resourceClass === Material::class && $value !== "") {
            $materialAlias = $queryBuilder->getRootAliases()[0];
            $organizationAlias = "org";
            // we join here to be able to also search for attributes of the organization
